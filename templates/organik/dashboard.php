...
<body>
    ...
    <!-- Flot -->
    <script src="<?php echo template_js(); ?>/plugins/flot/jquery.flot.js"></script>
    <script src="<?php echo template_js(); ?>/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<?php echo template_js(); ?>/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<?php echo template_js(); ?>/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<?php echo template_js(); ?>/plugins/flot/jquery.flot.pie.js"></script>
    ...
    <!-- GITTER -->
    <script src="<?php echo template_js(); ?>/plugins/gritter/jquery.gritter.min.js"></script>
    <script src="js/plugins/gritter/jquery.gritter.min.js"></script>

    <!-- Sparkline -->
    <script src="<?php echo template_js(); ?>/plugins/sparkline/jquery.sparkline.min.js"></script>
    <script src="js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="<?php echo template_js(); ?>/demo/sparkline-demo.js"></script>
    <script src="js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="<?php echo template_js(); ?>/plugins/chartJs/Chart.min.js"></script>
